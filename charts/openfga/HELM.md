...
| openfga.datastore.existingSecret | string | `"kopexa-cluster-app"` |  |
| openfga.datastore.uri | string | `"postgres://pooler-kopexa-rw:5432/kopexa_fga"` |  |
| openfga.datastore.secretKeys.usernameKey | string | `"username"` |  |
| openfga.datastore.secretKeys.passwordKey | string | `"password"` |  |
| openfga.datastore.maxCacheSize | string | `nil` |  |
| openfga.datastore.maxOpenConns | int | `50` |  |
